...
$liste=$disease1C->retrieveDiseaseById($_GET['id']);
 include "../../entities/patient.php";
      include "../../core/patientC2.php";
...
$desease=$disease1C->getLatestDesease($_GET['id']);
$row2  = $desease-> fetch();
...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/consul.jpg');">
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         ...
         <h1 class="mb-0 bread">Fiche Patient </h1>
     </div>
 </div>
</div>
</section>
   ...
   <div class="container">
    ...
    <div class="row d-flex contact-info">
      <div class="col-md-3 d-flex">
       ...
       <h3 class="mb-2">Patient</h3>
       <p><?php echo $row['civility'].'. '.$row['name'].' '.$row['surname']; ?></p>
     </div>
   </div>
   <div class="col-md-3 d-flex">
     <div class="align-self-stretch box p-4 text-center">
     ...
     <h3 class="mb-2">Téléphonne</h3>
     <p>+216 <?php echo $row['phone']; ?></p>
   </div>
 </div>
 <div class="col-md-3 d-flex">
   <div class="align-self-stretch box p-4 text-center">
   ...
   <h3 class="mb-2">Date de naissance</h3>
   <p><?php echo $row['birthDay'].' , '.$row['birthPlace']; ?></p>
 </div>
</div>
<div class="col-md-3 d-flex">
 <div class="align-self-stretch box p-4 text-center">
 ...
 <h3 class="mb-2">Situation familiale</h3>
...
<div class="col-md-3 d-flex">
 ...
 <p><?php echo $row['adress'].', '.$row['postal'].', '.$row['city']; ?></p>
</div>
</div>

<div class="col-md-3 d-flex">
 <a href="mes-consultations.php?id=<?php echo "4"; ?>"><div class="align-self-stretch box p-4 text-center">
  <div class="icon d-flex align-items-center justify-content-center">
   <span class="fa fa-map-marker"></span>
 </div>
 <h3 class="mb-2">Nombre de consultations</h3>
 <p><?php echo $i; ?></p>
</div></a>
</div>
...
<div class="col-md-3 d-flex">
 ...
 <h3 class="mb-2">Dernière consultation</h3>
 <p><?php echo 'Du : '.$row2['stayDate'].' Au : '.$row2['endDate']; ?></p>
</div>
</div>
...
<div class="col-md-4">
  <a href="update-info.php?id=<?php echo $_GET['id']; ?>" class="btn btn-dark px-4 py-3" style="margin-left: 89px;">Modifier</a>
  <a href="book.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary px-4 py-3">Prendre rdv</a>
</div>
</div>
