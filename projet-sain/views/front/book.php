  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       ...
       <h1 class="mb-0 bread">Prendre un rendez-vous </h1>
     </div>
   </div>
 </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row block-9">
      ...
      <div class="col-md-8 order-md-last d-flex">
        <form action="bookRequest.php?id=<?php echo $_GET['id']; ?>" class="bg-light p-5 contact-form" method="post" nctype="multipart/form-data">
