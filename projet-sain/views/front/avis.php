                            ...
                            <div class="project-wrap hotel">
                                ...
                                <p class="mb-2"><span class="star"> avis </span>
                                    ...
                                    <form method="POST">
                                                ...
                                                <li><span class="fa fa-reply "></span><?php echo $replays1; ?></li>
                                            </form>
                                    </ul>
                                    <?php
...
if (isset($_POST['replay'])) {
    ...
    $reponse = new reponse($_SESSION['id'],$_POST["idc"], $_POST["replay"]);

    $reponseC->ajouterreponse($reponse);

?>
    <script>
        window.location.replace("avis.php?idc=<?php echo $_POST["idc"]; ?>");
    </script>
<?php
}
?>
