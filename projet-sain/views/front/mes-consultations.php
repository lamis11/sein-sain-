...
$liste=$disease1C->retrieveDiseaseById($_SESSION['id']);
  ?>
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Accueil<i class="fa fa-chevron-right"></i></a></span> <span>Mes Consultations <i class="fa fa-chevron-right"></i></span></p>
         <h1 class="mb-0 bread">Historique de mes consultations </h1>
     </div>
 </div>
</div>
</section>
   ...
   <div class="container">
    <div class="row">
     <?php foreach ($liste as $row) 
      {
        if ($row['state'] == "Demande passée")
        {
      ?>
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                      <div class="text p-4">
                          <span class="days">Demande envoyée</span>
                          <h3><?php echo $row['pathology']; ?></h3>
                      </div>
                    </div>
                </div>
      <?php
      ...
      ?>
                  <div class="col-md-4 ftco-animate">
                        <div class="project-wrap">
                          <div class="text p-4">
                             <span class="days"><?php echo $row['department']; ?></span>
                             <h3><?php echo $row['pathology']; ?></h3>
                             <p class="location"><span class="fa fa-map-marker"></span> <?php echo $row['facility']; ?></p>
                             <ul>
                                <li>Admission : <?php echo $row['stayDate']; ?></li>
                                <li>Sortie : <?php echo $row['endDate']; ?></li>
                                <li>Diagnostique : <?php echo $row['diagnosis']; ?></li>
                            </ul>
                        </div>
                        </div>
                  </div>
